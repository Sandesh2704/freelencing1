        ...
        <>
            ...
            <section ref={investSectionRef} className='w-full mx-auto flex flex-wrap my-14'>
                <div className='w-full md:w-full lg:w-5/12 h-auto p-0 md:p-1 lg:p-4'>
                    ...
                    <ul className="flex lg:flex-col cursor-pointer text-center md:text-start lg:text-start justify-center lg:justify-start px-0 md:px-0 lg:px-6">
                        {images1.map((image, index) => (
                            <li
                                key={index}
                                className={`mb-2  mb-3 md:mb-3 lg:mb-6 pb-3 mb:pb-0 lg:pb-0 `}
                    ...
                    <div className="mb-4">
                        {currentImage1 && (
                            <div className="bg-[#f8f7f5] rounded-lg">
                                ...
                                <img src={currentImage1} alt="Selected" className="w-full h-auto rounded-lg rounded-t-none lg:rounded-t-lg" />
                            </div>
                        )}
                    </div>
                </div>
                    ...
                    <div className="mb-4">
                        {currentImage2 && (
                            <div className="bg-[#f8f7f5] rounded-lg">
                                ...
                                <img src={currentImage2} alt="Selected" className="w-full h-auto rounded-lg rounded-t-none lg:rounded-t-lg" />
                            </div>
                        )}
                    </div>
                </div>
                <div className='w-full md:w-full lg:w-5/12 p-0 md:p-1 lg:p-4 rounded-lg'>
                    ...
                    <ul className="flex lg:flex-col cursor-pointer text-center md:text-start lg:text-start justify-center lg:justify-start px-0 md:px-0 lg:px-6">
                        {images2.map((image, index) => (
                            <li
                                key={index}
                                className={`mb-2 text-${activeButton2 === index + images1.length ? 'green' : 'gray'}-500 mb-3 md:mb-3 lg:mb-6  pb-3 mb:pb-0 lg:pb-0`}
            ...
            <section ref={learnSectionRef} className='w-full my-20'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 h-auto lg:h-96 gap-4'>
                    <div className='grid'>
                        <Link to=' ' className="bg-white flex lg:block rounded-lg shadow-md ">
                            <div>
